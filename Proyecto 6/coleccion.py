...
class Manejador:
    ...
    def punto2(self):
        ...
        if(op=='1'):
            ...
            aparato=Lavarropas(marca,modelo,color,pais,precio,capacidadLavado,velocidadCentrifugado,cantiProgramas,tipoCarga)
        elif(op=='3'):
            tipoPantalla=input('ingrese tipo de pantalla (crt, vga, svga, plasma, lcd, led, TouchScreen, MultiTouch):')
