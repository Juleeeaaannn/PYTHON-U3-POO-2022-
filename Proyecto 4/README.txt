...
Una Empresa que funciona 8 horas diarias, necesita calefaccionar todas las oficinas que la conforman. Para ello debe elegir entre dos tipos de calefactores: eléctricos o a gas natural. La elección de uno u otro, está basada en el costo del consumo de cada uno de ellos.

De todos los calefactores se registra  una marca y un modelo.

De un calefactor eléctrico se registra además, la potencia máxima por ejemplo: 500 watts.

De un calefactor a gas natural se registra además, matrícula por ejemplo: GN01-00001-06-057, y calorías por ejemplo: 4000kilocalorias/m3. 
